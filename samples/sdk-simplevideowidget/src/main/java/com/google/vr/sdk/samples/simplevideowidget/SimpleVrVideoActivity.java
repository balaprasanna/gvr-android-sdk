...
public class SimpleVrVideoActivity extends Activity {
  ...
  private void handleIntent(Intent intent) {
    ...
    //Uri url = Uri.parse("https://devimages.apple.com.edgekey.net/streaming/examples/bipbop_16x9/bipbop_16x9_variant.m3u8");
    //Uri url = Uri.parse("https://s3-us-west-2.amazonaws.com/alab2016/sampleweb.webm");
    Uri url = Uri.parse("https://s3-us-west-2.amazonaws.com/alab2016/02.webm");
    System.out.println("you-"+url.toString());
    fileUri = url;

    // for mp4, webm, and some common formats.
    videoOptions.inputFormat = Options.FORMAT_DEFAULT;

    // for hls Https live straming
